...
--
-- CREATE INDEX CONCURRENTLY does not hold a ShareLock for the full build so it
-- does not block concurrent writes.  Must run outside a transaction.
--
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_authz_order_nonvalid
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_authz_acct_ident
