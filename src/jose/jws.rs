...
const PS256_ALG_DER: &[u8] = &[
    ...
    0xa2, 0x03, 0x02, 0x01, 0x20, // trailerField [3] EXPLICIT: 1 (BC)
...
const PS384_ALG_DER: &[u8] = &[
    ...
    0x09, 0x60, 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x02, 0x02, 0xa2, 0x03, 0x02, 0x01,
    0x30, // saltLength = 48
    0xa3, 0x03, 0x02, 0x01, 0x01,
];
...
const PS512_ALG_DER: &[u8] = &[
    ...
    0x30, 0x18, 0x06, 0x09, 0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x01, 0x08, 0x30, 0x0b, 0x06,
    0x09, 0x60, 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x02, 0x03, 0xa2, 0x03, 0x02, 0x01,
    0x40, // saltLength = 64
    0xa3, 0x03, 0x02, 0x01, 0x01,
];
